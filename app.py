...
@app.route('/')
def index():
    return('<center><h1> Rest API for predicting Coronary Heart Disease created by <a href="https://github.com/devesh2511">Devesh</a></p> </h1>'+
            ...
            '<p>For more details view <a href="https://github.com/devesh2511/HeartDiseasePredictionAPI">source</a></p></center>')
